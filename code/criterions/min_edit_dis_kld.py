...
class MinEditDisForwardKLD(VariousDivergence):
    ...
    def forward(
        ...
        loss = self.compute_cross_entropy_loss(
            outputs.logits, batch["label_batch"]["label"], log=log
        )[0]
    ...
    def get_aligned_teacher_logits(
        self, logits, teacher_logits, batch, distiller,
    ):
