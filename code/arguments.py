...
def add_runtime_args(parser: argparse.ArgumentParser):
    ...
    group.add_argument("--on-policy", action="store_true")
    group.add_argument("--on-policy-after-n-epochs", type=int, default=3)
    group.add_argument("--stu-gen-ratio", type=float, default=0.5)
    return parser
